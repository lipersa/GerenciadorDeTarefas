...
class Usuario(database.Model, UserMixin):
    ...
    cargo = database.Column(database.String(50), nullable=False, default='Usuario')
    permissionamento = database.Column(database.String(50), nullable=False, default='Padrao')
    tarefas_criadas = database.relationship('Tarefa', foreign_keys='Tarefa.criador_id', backref='criador', lazy=True)
    tarefas_recebidas = database.relationship('Tarefa', foreign_keys='Tarefa.responsavel_id', backref='responsavel', lazy=True)
